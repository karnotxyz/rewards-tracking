...
-- CreateIndex
CREATE UNIQUE INDEX "Ledger_block_number_tx_index_event_index_order_index_key" ON "Ledger"("block_number", "tx_index", "event_index", "order_index");

-- CreateIndex
CREATE UNIQUE INDEX "Commissions_ledger_id_referral_code_key" ON "Commissions"("ledger_id", "referral_code");
